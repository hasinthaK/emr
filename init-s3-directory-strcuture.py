...
query_names = ["carrier_delay_query", 
                   "nas_delay_query", 
                   "weather_delay_query", 
    ...
    for i in range(0, 5):
        for query_name in query_names:
            for folder in output_folders:
                st_file_name = f"{folder}/{query_name}/{i}/timestamps/start_time/keep"
                end_file_name = f"{folder}/{query_name}/{i}/timestamps/end_time/keep"
                results_file_name = f"{folder}/{query_name}/{i}/results/keep"
